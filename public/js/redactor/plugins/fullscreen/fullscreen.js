...
EditorPlugins.fullscreen = {
	...
	toggleFullscreen: function()
	{
		...
		if (!this.fullscreen)
		{
			...
			this.$box.addClass('editor_box_fullscreen');
		...
		else
		{
			...
			this.$box.removeClass('editor_box_fullscreen').css({ width: 'auto', height: 'auto' });
	...
	fullscreenIframe: function(html)
	{
		...
		if (this.opts.wym) this.$editor.addClass('editor_editor_wym');
	},
