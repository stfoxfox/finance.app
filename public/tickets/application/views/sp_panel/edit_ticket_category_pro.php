        ...
        <div class="col-md-9">
			...
			<div class="block-normal bot-rounded-corners lightShadow bot-margin">
				<div class="block-content-main">
					...
					<p><?php echo lang("pg_sp_edit_ticket_cat_text2") ?></p>

					<?php echo form_open(site_url("sp_panel/edit_ticket_category_pro_pro/" . $info->ID)) ?>
					<div class="panel panel-default">
						<div class="panel-heading"><?php echo lang("pg_sp_edit_ticket_cat") ?></div>
						<div class="panel-body">
						  	<div class="form-group">
								<div class="row">
									<div class="col-md-12">
									    <label for="title-in"><?php echo lang("pg_sp_category_name") ?></label>
									    <input type="text" class="form-control" id="title-in" name="name" placeholder="" value="<?php echo $info->name ?>" >
									</div>
								</div>
							</div>
