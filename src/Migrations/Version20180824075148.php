 ...
 */
final class Version20180824075148 extends AbstractMigration implements ContainerAwareInterface
{
    private $container;
    ...
    {
        $this->addSql('DROP TRIGGER check_transaction ON transaction');
    }
}
